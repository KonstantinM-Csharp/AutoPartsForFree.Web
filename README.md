# AutoPartsForFree
Web-приложение для скачивания .csv файла с почтового ящика и загрузки в базу на ASP.NET MVC.
...
# Ресурсы
Конфигурация для почтового ящика и названия столбцов содержатся в файле config.json. В файле указаны рабочие тестовые данные от почты yandex. Скрипт для базы хранится в файле AutoPartsDB.sql. СУБД - MS SQL. 
